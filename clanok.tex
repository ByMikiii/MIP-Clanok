...
\usepackage{hyperref} % odkazy v texte budú aktívne (pri niektorých 
triedach dokumentov spôsobuje posun textu)
...
práce, ak. rok 2015/16, vedenie: Meno Priezvisko}} % meno a priezvisko 
vyučujúceho na cvičeniach
...
\section{Nova sekcia} \label{novasekcia} % prípadne iný variant názvu
...
% týmto sa generuje zoznam literatúry z obsahu súboru literatura.bib podľa 
